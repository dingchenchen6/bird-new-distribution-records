# Bird New-Record Analysis Tasks

This directory stores analysis tasks as independent modules. Each task follows the same structure:
本目录将不同分析任务模块化存放，每个任务统一采用相同结构：

- `figures`: figure outputs
- `code`: R scripts with bilingual step-by-step comments
