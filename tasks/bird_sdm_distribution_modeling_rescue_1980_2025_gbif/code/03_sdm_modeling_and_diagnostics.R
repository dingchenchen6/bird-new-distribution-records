...
# ------------------------------------------------------------
# English:
# When the remaining rescue-target new-record bird species are modeled with
# cleaned China Birdwatch occurrences from 1980 to 2025 plus GBIF records,
# what China-only potential distributions emerge across provinces?
#
# 中文：
# 当将待补救的新纪录鸟类物种基于 1980-2025 年中国观鸟清洗记录并结合 GBIF
# 记录重新建模时，它们在中国各省会呈现怎样的潜在分布格局？
#
# Goal | 目标
# ------------------------------------------------------------
# English:
# Run the end-to-end rescue SDM workflow, evaluate model quality, export
# rasters, overlay cleaned modeling points on species maps, and summarize
# province-level suitable area and proportion for every successfully modeled
# species.
#
# 中文：
# 运行端到端补救版 SDM 流程，评估模型质量，导出栅格结果，在物种地图中叠加
# 清洗后的建模点，并汇总每个成功建模物种在各潜在省份中的适生面积与比例。
# ============================================================
